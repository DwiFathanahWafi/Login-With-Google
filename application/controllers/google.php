...
class google extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $google_client->setRedirectUri('http://localhost/google/google'); //Define your Redirect Uri
        ...
        if (!$this->session->userdata('access_token')) {
            $login_button = '<a href="' . $google_client->createAuthUrl() . '"><img src="' . base_url() . 'p.jpg" /></a>';
